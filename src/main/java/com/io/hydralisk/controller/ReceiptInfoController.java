...
public class ReceiptInfoController {
    ...
    public Object userAddress() {
        ...
        Map rtnData = CommonUtils.ofMap("error", 0, "message", "success", "data", data, "url", CConstant.WEB_HOST+"/h5/pages/user_address/my");
        return rtnData;
    }
    ...
    public Object add(@RequestParam(required = false) String id) {
        if (CommonUtils.isBlank(id)) {
            ...
            Map rtnData = CommonUtils.ofMap("error", 0, "message", "success", "data", data, "url", CConstant.WEB_HOST+"/h5/pages/user_address/add");
            return rtnData;
        }
